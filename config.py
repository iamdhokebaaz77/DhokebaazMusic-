...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", -1002530598349))
LOGGER_ID = LOG_GROUP_ID
# Get this value from @MissRose_Bot on Telegram by /id
OWNER_ID = int(getenv("7973954776", None))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/iamdhokebaaz77/DhokebaazMusic-",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/+L6qe2mojMIFjN2E1")
